...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_MPOS = treatment room species newtime week newtime*week treatment*newtime treatment*week  / s ddfm=kr;
Random monkey(treatment room species);
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_MPOS = treatment room species newtime week treatment*week treatment*newtime newtime*week / s ddfm=kr; 
*Random monkey(treatment room species);
Random week /type=ar(1) subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_MNEG = treatment room species newtime week newtime*week treatment*newtime treatment*week  / s ddfm=kr;
Random monkey(treatment room species);
Random week /type=ar(1) subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
run;
...
reset print;
ndf=4;  /*get from type 3 table for your specific effect*/
ddf=40; /*get from type 3 table for your specific effect*/
probability=0.1; /*your establish probability %*/
ftab=finv(1-probability,ndf,ddf);
run;
quit;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_MNEG = treatment room species newtime week treatment*week treatment*newtime newtime*week / s ddfm=kr; 
*Random monkey(treatment room species);
*Random week /type=cs subject=monkey(treatment room species); 
Repeated newtime /type=cs subject=week(treatment room species monkey); 
lsmeans newtime treatment week newtime*week treatment*newtime treatment*week;
...
data estit2;
set estit;
cd = sqrt(17*2.09095)*StdErr; /*18 comparisons of interest*/
ss = '      '; 
run;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_HInt = treatment room species newtime week newtime*week treatment*newtime treatment*week  / s ddfm=kr;
Random monkey(treatment room species);
Random week /type=ar(1) subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
run;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_HInt = treatment room species newtime week treatment*week treatment*newtime newtime*week / s ddfm=kr; 
*Random monkey(treatment room species);
Random week /type=cs subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
lsmeans newtime treatment week newtime*week treatment*newtime treatment*week;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_Mint = treatment room species newtime week newtime*week treatment*newtime treatment*week  / s ddfm=kr;
Random monkey(treatment room species);
Random week /type=ar(1) subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
run;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_Mint = treatment room species newtime week treatment*week treatment*newtime newtime*week / s ddfm=kr; 
*Random monkey(treatment room species);
Random week /type=cs subject=monkey(treatment room species); 
*Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
lsmeans newtime treatment week newtime*week treatment*newtime treatment*week;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_SGr = treatment room species newtime week newtime*week treatment*newtime treatment*week  / s ddfm=kr;
Random monkey(treatment room species);
Random week /type=ar(1) subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
run;
...
reset print;
ndf=4;  /*get from type 3 table for your specific effect*/
ddf=52; /*get from type 3 table for your specific effect*/
probability=0.1; /*your establish probability %*/
ftab=finv(1-probability,ndf,ddf);
run;
quit;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_SGr = treatment room species newtime week treatment*week treatment*newtime newtime*week / s ddfm=kr; 
*Random monkey(treatment room species);
Random week /type=cs subject=monkey(treatment room species); 
*Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
lsmeans newtime treatment week newtime*week treatment*newtime treatment*week;
...
data estit2;
set estit;
cd = sqrt(17*2.0562212)*StdErr; /*9 comparisons of interest*/
ss = '      '; 
run;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_Ab = treatment room species newtime week newtime*week treatment*newtime treatment*week  / s ddfm=kr;
*Random monkey(treatment room species);
Random week /type=cs subject=monkey(treatment room species); 
*Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
run;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_Ab = treatment room species newtime week treatment*week treatment*newtime newtime*week / s ddfm=kr; 
*Random monkey(treatment room species);
Random week /type=cs subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
lsmeans newtime treatment week newtime*week treatment*newtime treatment*week;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_Ea = treatment room species newtime week newtime*week treatment*newtime treatment*week  / s ddfm=kr;
Random monkey(treatment room species);
Random week /type=ar(1) subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
run;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_Ea = treatment room species newtime week treatment*week treatment*newtime newtime*week / s ddfm=kr; 
*Random monkey(treatment room species);
Random week /type=cs subject=monkey(treatment room species); 
*Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
lsmeans newtime treatment week newtime*week treatment*newtime treatment*week;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_Lo = treatment room species newtime week newtime*week treatment*newtime treatment*week  / s ddfm=kr;
Random monkey(treatment room species);
Random week /type=ar(1) subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
run;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_Lo = treatment room species newtime week treatment*week treatment*newtime newtime*week / s ddfm=kr; 
*Random monkey(treatment room species);
Random week /type=cs subject=monkey(treatment room species); 
*Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
lsmeans newtime treatment week newtime*week treatment*newtime treatment*week;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_Self = treatment room species newtime week newtime*week treatment*newtime treatment*week  / s ddfm=kr;
Random monkey(treatment room species);
Random week /type=ar(1) subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
run;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_Self = treatment room species newtime week treatment*week treatment*newtime newtime*week / s ddfm=kr; 
*Random monkey(treatment room species);
Random week /type=ar(1) subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
lsmeans newtime treatment week newtime*week treatment*newtime treatment*week;
...
Title 'Frequency of Group_SocInt';
/*STEP 1: Covariance*/
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_SocInt = treatment room species newtime week newtime*week treatment*newtime treatment*week  / s ddfm=kr;
Random monkey(treatment room species);
Random week /type=ar(1) subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
run;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_SocInt = treatment room species newtime week treatment*week treatment*newtime newtime*week / s ddfm=kr; 
Random monkey(treatment room species);
Random week /type=ar(1) subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
lsmeans newtime treatment week newtime*week treatment*newtime treatment*week;
...
Title 'Frequency of Group_Active';
/*STEP 1: Covariance*/
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_Active = treatment room species newtime week newtime*week treatment*newtime treatment*week  / s ddfm=kr;
Random monkey(treatment room species);
Random week /type=ar(1) subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
run;
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_Active = treatment room species newtime week treatment*week treatment*newtime newtime*week / s ddfm=kr; 
*Random monkey(treatment room species);
Random week /type=cs subject=monkey(treatment room species); 
*Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
lsmeans newtime treatment week newtime*week treatment*newtime treatment*week;
...
Title 'Frequency of Group_Inactive';
/*STEP 1: Covariance*/
...
Proc mixed data= hdir1 lognote;
Class treatment room monkey week newtime species;
Model Group_Inactive = treatment room species newtime week newtime*week treatment*newtime treatment*week  / s ddfm=kr;
Random monkey(treatment room species);
Random week /type=ar(1) subject=monkey(treatment room species); 
Repeated newtime /type=ar(1) subject=week(treatment room species monkey); 
run;
